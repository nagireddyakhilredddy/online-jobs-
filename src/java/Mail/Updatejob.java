...
public class Updatejob extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                PreparedStatement pst = con.prepareStatement("update jobs set requirments ='"+requirment+"', cname ='"+cname+"', jobrole ='"+jrole+"',package ='"+packg+"',cdetails ='"+dbFileName+"',username ='"+username+"' where username='"+username+"'");
